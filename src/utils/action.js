...
function getEnv(name, required = false) {
  ...
  // @note Value is either not set (`undefined`) or set to `null`
	 if (required) {
...
/**
 * Returns the value for an input variable. If the variable is required but doesn't have a value,  an error is thrown
 * @param {string} name - Name of the input variable
 * @param {boolean} required - Whether an error should be thrown if the variable doesn't have a value
